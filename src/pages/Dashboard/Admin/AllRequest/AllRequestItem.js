...
import '../../User/UserRequest/userRequest.css'

const AllRequestItem = ({ item, deleteMassage }) => {
        ...
        <div className='container col-12 col-md-4 userRequestItemContainer '>
            <div className='boxShadow'>
                <div>
                    ...
                    <small className='p-0 m-0 text-secondary'> To: {item.to} <br /> From: {item.from} <br /> <small>Time : {item.time}</small></small>
                    <span></span>
                </div>
            </div>
        </div>
